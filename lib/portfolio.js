...
const portfolioData = [
  {
    title: '[U Don\'t Know Me! (in progress)](https://github.com/udontknowmeapp/udontknowme)',
    description: 'U Don\'t Know Me is a web-based trivia game: think, Cards \
    Against Humanity meets two-truths-and-a-lie. The project morphed out of \
    [Hack Upstate](http://hackupstate.com) and is a collaboration with \
    [Jordan Messina](http://jordanmessina.com/). UDKM is a work in progress, so \
    keep an eye out for something on Product Hunt in the near future. ;)',
    links: [{
      type: 'github',
      href: 'https://github.com/udontknowmeapp/udontknowme',
    }],
    image: 'udkm.jpg',
  },
  {
